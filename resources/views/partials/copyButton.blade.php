<div>
    <button type="button" onclick="handleClickCopy('{{ $listing->listingId }}')" onmouseleave="handleMouseoutCopy('{{ $listing->id }}')" data-tooltip-target="tooltip-{{ $listing->id }}" class="justify-center self-center whitespace-nowrap focus:ring-2 rounded focus:outline-none focus:ring-blue-300 p-2">
